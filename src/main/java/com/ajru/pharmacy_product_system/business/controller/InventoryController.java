...
public class InventoryController {
    ...
    public ResponseEntity<ClassificationDto> addClassification(
        ...
        logger.info(StringConstants.WEB_REQ.getValue(), classification);
    ...
    public ResponseEntity<List<ClassificationDto>> getClassifications(
        ...
        logger.info(StringConstants.WEB_RESP.getValue(), classificationsDto);
    ...
    public ResponseEntity<ClassificationDto> getClassification(
        ...
        logger.info(StringConstants.WEB_RESP.getValue(), classification);
        return new ResponseEntity<>(ClassificationDto.from(classification), HttpStatus.OK);
    }
    ...
    public ResponseEntity<ProductDto> deleteProduct(
        ...
        logger.info(StringConstants.WEB_RESP.getValue(), product);
    ...
    public ResponseEntity<ProductDto> editProduct(
        ...
        logger.info(StringConstants.WEB_RESP.getValue(), editedProduct);
    ...
    public ResponseEntity<ProductDto> getProduct(
        ...
        logger.info(StringConstants.WEB_RESP.getValue(),
                product);
        return new ResponseEntity<>(ProductDto.from(product), HttpStatus.OK);
    }
    ...
    public ResponseEntity<List<ProductDto>> getProducts(
        ...
        logger.info(StringConstants.WEB_RESP.getValue(), productsDto);
